...
<form class="form-horizontal" method="POST" action="" target="_blank">
	...
	<div class="form-group">
		<label class="col-md-4 control-label">{#lieu_exclusif#} :</label>
		<div class="col-md-5">
		<input type="checkbox" class="checkbox" name="lieu_exclusif" id="lieu_exclusif" {if $lieu.exclusif == 1}checked="checked"{/if}>
		</div>
	</div>
	<div class="form-group">
