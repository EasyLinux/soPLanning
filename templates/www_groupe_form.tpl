	...
	<div class="row">
		<div class="col-md-12">
			<div class="soplanning-box">
				<div class="btn-group">
					<a href="{$BASE}/projets.php" class="btn btn-sm btn-default" ><img src="assets/img/pictos/projets.png" class="picto-large" alt=""> {#menuListeProjets#}</a>
					<a href="{$BASE}/groupe_list.php" class="btn btn-sm btn-default"><img src="assets/img/pictos/groupes.png" class="picto-large" alt=""> {#menuListeGroupes#}</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="soplanning-box margin-top-10">
				...
				<form action="{$BASE}/process/groupe_save.php" method="POST" class="form-horizontal">
					...
					<div class="input-group">
						...
						<div class="col-md-8">
							<div class="input-group">
								<input name="nom" id="nom" type="text" class="form-control" value="{$groupe.nom|escape:"html"}" maxlength="100" />
